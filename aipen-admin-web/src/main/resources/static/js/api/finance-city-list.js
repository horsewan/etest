...
layui.use(['form', 'layer', 'table', 'util'], function () {
    ...
    pkgTable = table.render({
        ...
        cols: [[
            ...
            {field: 'singleNo', title: '客服总监编号', align: "center"},
...
//                    body.find("#bName").addClass('layui=hide');
    ...
    $('#pkg_add').on('click', function () {
        openCreate("/mall/financeCity/add");
    });
