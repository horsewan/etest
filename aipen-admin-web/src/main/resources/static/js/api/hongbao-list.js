...
layui.use(['form', 'layer', 'table', 'util'], function () {
    ...
    var tableIns = table.render({
        ...
        id: "productTable",
        url: '/mall/product/hongbaoDataTable',
        where: {
        ...
        cols: [[
            ...
            {field: 'productNo', title: '红包编号', align: "center", width: 120},
            {field: 'productName', title: '红包名称', align: "center", width: 300},
            {field: 'originalPrice', title: '红包面额', align: "center", width: 100},
            // {field: 'productDesc', title: '红包简称', align: "center"},
    ...
    function open(url, data) {
        var index = layui.layer.open({
            ...
            type: 2,
            area: ['700px', '600px'],
            content: "/mall/product/hongbaoPage",
    ...
    table.on('tool(productTableList)', function (obj) {
        ...
        switch (layEvent) {
            case "edit":
                open("/mall/product/hongbaoEdit", data);
                break;
            case "delete":
                layer.confirm("是否删除此红包?", {
                    icon: 3,
                    title: '温馨提示',
                    closeBtn: 0,
                }, function (index) {
                    ...
                    top.asyncRequest({
                        url: "/mall/product/hongbaoDelete/" + data.id,
                        type: "get",
                        dataType: "json",
            ...
            case "detail":
                var index = layui.layer.open({
                    title: "产品详情",
                    type: 2,
                    content: "/mall/product/hongbaoDetail/" + data.id,
                    success: function (layero, index) {
                        setTimeout(function () {
                            layui.layer.tips('点击此处返回列表', '.layui-layer-setwin .layui-layer-close', {
                                tips: 3,
