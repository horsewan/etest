...
public class LogAspect {
    ...
    public void doAfterReturning(JoinPoint joinPoint, Object result) throws Throwable {
        logThreadPool.execute(new LogTask(joinPoint, WebKit.getRequest(),
                StringUtils.isBlank(ShiroKit.loginName()) ? "匿名访问" : ShiroKit.loginName(),
    ...
    public class LogTask implements Runnable{
        ...
        @Override
        public void run() {
            SysLog log = setRequestInfo(joinPoint, request);
